const TokenLaunchBanner = () => {
  return (
    <div className='relative overflow-hidden w-full pt-24'>
      ...
      <div className='mx-auto py-4 md:py-8 px-10'>
        <div className='md:w-8/12 lg:w-6/12 text-5xl mb-4 md:mb-6 px-4 md:text-6xl text-white bg-clip-text text-transparent title-animate'>
          Create your own token fast. 
          <a className="px-4 py-2 bg-gradient-to-r from-[#645CF5] to-[#8016D1] bg-clip-text text-transparent">
            No coding required
          </a>
        </div>
        <p className='subtitle-animate text-gray-300 px-4 mx-auto text-base md:text-lg'>
      ...
      <button className='subtitle-animate mx-14 mb-40 lg:mb-72 md:mb-32 px-8 py-4 rounded-full text-lg md:text-xl bg-gradient-to-r from-[#2A39FF] to-[#5B1B8C] text-gray-300'>
        Get started now
      </button>
    </div>
  );
